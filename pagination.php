...
// Setting the limit with sessions
...
// Setting the selected order with session
...
// COMMAND ALTERED TO MAKE THE ORDER SELECTABLE
$statement = $db_con->prepare("select * from student ORDER BY student_id ". $order . " LIMIT $start_from, $limit");
$statement->execute();
